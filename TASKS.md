...
| C.22 | Simplify CLI/runtime startup interface | ⏳ | In progress: introducing `tubo` unified CLI, YAML config, topology rendering, and thin legacy runtime wrappers while preserving env compatibility |
