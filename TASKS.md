...
> **Last updated:** 2026-05-06 15:36 UTC
...
| C.42 | Signed public onboarding + CLI UX simplification (PR #68 follow-up) | ⏳ | In progress on prerelease branch `prerelease/pr68-signed-public-onboarding`; GitHub issues opened: #69 #71 #72 #73 #74; implemented #69 + core #71 + #72 (`tubo join` bundle mode) + #73 (implicit public join for `attach`/`connect`/`gateway`) and partial #74 (legacy role commands rejected, `attach <name> --port <port>` shorthand, CLI docs updated) |
