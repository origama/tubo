...
1. **Issue #81 — cluster invitations and local join flow**: add invite/share/join flows for cluster membership without changing Discovery V2 or data-plane auth (`enhancement`, `area:cli`, `area:docs`, `prio:medium`)
