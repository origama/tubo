...
### Changed
- Detached startup now requires configured health readiness before success and rolls back owned child processes plus partial PID/state metadata after any post-start failure. Detached `connect` allows 30 seconds for remote discovery and relay setup before rollback.
