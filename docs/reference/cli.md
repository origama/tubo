...
# if joined with a grant-requester invite, --peer can be omitted; Tubo will re-discover a fresh grant peer if the saved one is stale
tubo grants history
