...
- [`SECURITY.md`](./SECURITY.md) — Current security policy, current limits, and links to the next security model
- [`security-model-0.7.md`](./security-model-0.7.md) — Canonical 0.7.0.b0 security/trust model, guarantees, and non-goals for ID-first discovery and scoped trust
...
- [`cli.md`](./cli.md) — CLI reference per `tubo`, YAML config e flussi locali/join
...
- [`obsoletes/README.md`](./obsoletes/README.md) — Historical design notes superseded by the current canonical documents
