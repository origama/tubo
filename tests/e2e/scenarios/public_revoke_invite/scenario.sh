...
[[ "$share_token_1" != "$share_token_2" ]] || fail "expected a fresh share invite token after revoke"
...
echo "[e2e] PASS: revoked share invite cannot be redeemed and fresh token works"
